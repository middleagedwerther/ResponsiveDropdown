...
const Container = styled.div`
  ...
  padding: 20px;
  display: grid;
  grid-template-columns: auto 3fr 6px 2fr;
  padding: 0;
...
const BigVerticalDivider = styled.span`
  height: calc(100% - 4px); /* 100% height minus the top and bottom margins */
  width: 1px;
  background-color: white;
  color: white;
  margin: 2px 0; /* 2px margin at the top and bottom */
  justify-self: center;
  align-self: center;
...
export default function FooterWithIcon() {
      ...
      <LeftContainer>
        ...
        <RightContainer>
          ...
          <div style={{ gap: '20px' }}>
            ...
            <FontAwesomeIcon icon={faPhone} style={{ marginRight: '2px' }} /> {/* Add margin here */}
            0412 123 456</PhoneLink>
            ...
            <FontAwesomeIcon icon={faClock} /> 
              ...
              <div style={{ marginLeft: '25px' }}> 7am to 7pm </div>
